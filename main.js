          ...
          <ul>
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  ...
                  <a class="listTitle" href="/?id=오늘 본 고양이 사진 올린다.">오늘 본 고양이 사진 올린다.</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  <a class="listCategory" href="http://">유머</a>
                  <a class="listTitle" href="/?id=승은이가 어제 보내준 사진인데 완전 웃김 ㅋㅋㅋㅋ">승은이가 어제 보내준 사진인데 완전 웃김 ㅋㅋㅋㅋ</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  ...
                  <a class="listTitle" href="/?id=지금 카펜데 노트북 써야 하는데 콘센트가 안보인다 어떡하지">지금 카펜데 노트북 써야 하는데 콘센트가 안보인다 어떡하지</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  <a class="listCategory" href="http://">잡담</a>
                  <a class="listTitle" href="/?id=나에게 남겨진 배터리 시간은 4시간.. 생각보다 충분한 것 같은걸">나에게 남겨진 배터리 시간은 4시간.. 생각보다 충분한 것 같은걸?</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  <a class="listCategory" href="http://">잡담</a>
                  <a class="listTitle" href="/?id=요즘 밀크티가 맛있는데 추천좀">요즘 밀크티가 맛있는데 추천좀</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  <a class="listCategory" href="http://">잡담</a>
                  <a class="listTitle" href="/?id=두둠칫두둠칫">두둠칫두둠칫</a>
            ...
            <li>
              <div class="listWarp">
                <div class="listTitle">
                  <a class="listCategory" href="http://">잡담</a>
                  <a class="listTitle" href="/?id=텔레포트 기능 구현좀">텔레포트 기능 구현좀</a>
        ...
        <body>
          ...
          <div id="list">
            <ul>
              <li>
                  <a class="listCategory" href="http://">유머</a>
                  <a class="listTitle"  href="${title}">${title}</a>
